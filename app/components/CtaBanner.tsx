    ...
    <section className="bg-canvas pb-24 md:pb-32">
      <div className="mx-auto max-w-[1400px] px-6">
        <motion.div
          ...
          className="grain relative overflow-hidden rounded-5xl bg-ink-950 p-10 text-canvas shadow-diffusion md:p-16"
        >
          ...
          <div className="relative grid grid-cols-1 gap-10 md:grid-cols-12 md:items-end">
            ...
            <div className="md:col-span-4 md:justify-self-end">
              ...
              >
                ...
                <ArrowUpRight size={18} weight="bold" className="transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
              </Link>
              <div className="mt-4 font-mono text-[11px] uppercase tracking-[0.18em] text-canvas/50">
